                        ...
                        if model_type == 'FFC':
                            if dcls >= 0 and dcls <= 18 and find_feature(features, 'od'):
                                ...
                                if ignored_obj:
                                    ...
                                    od.append({"bbox": [xmin, ymin, xmax, ymax], "class_name": metadata_ffc[dcls]})
                                ...
                                if ignored_obj:
                                    ...
                                    if 'ts_' in metadata_ffc[dcls] and 'ts_sup_' not in metadata_ffc[dcls]:
                                        tstld.append({"bbox": [xmin, ymin, xmax, ymax], "class_name": "ts_ignored"})
                                    elif 'ts_sup_' in metadata_ffc[dcls]:
                                        tstld.append({"bbox": [xmin, ymin, xmax, ymax], "class_name": "ts_sup_ignored"})
                                    elif 'tl_' in metadata_ffc[dcls]:
                                        tstld.append({"bbox": [xmin, ymin, xmax, ymax], "class_name": "tl_ignored"})
                                    
                                else:
                                    tstld.append({"bbox": [xmin, ymin, xmax, ymax], "class_name": metadata_ffc[dcls]})
                                ...
                                if ignored_obj:
                                    ...
                                    sod.append({"bbox": [xmin, ymin, xmax, ymax], "class_name": metadata_ffc[dcls]})
